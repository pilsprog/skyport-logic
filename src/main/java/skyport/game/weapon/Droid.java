    ...
    public boolean setDirections(JSONArray directionArray, int levelArg) {
        ...
        try {
            for (int i = 0; i < directionArray.length(); i++) {
                ...
                if (!(direction.equals("up") || direction.equals("down") || direction.equals("left-up") || direction.equals("left-down") || direction.equals("right-up") || direction.equals("right-down"))) {
                    return false;
                }
